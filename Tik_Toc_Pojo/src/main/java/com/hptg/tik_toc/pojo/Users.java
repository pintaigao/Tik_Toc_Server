...
public class Users {
     ...
     * 用户名
     */
    @ApiModelProperty(value = "用户名", name = "username", example = "hptg", required = true)
    private String username;

    /**
     * 密码
     */
    @ApiModelProperty(value = "密码", name = "password", example = "qwerty", required = true)
