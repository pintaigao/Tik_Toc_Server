...
//	private CommentsMapperCustom commentMapperCustom;
    ...
    public String saveVideo(Videos video) {
        ...
        video.setId(id);
        videosMapper.insertSelective(video); // 保存一个实体，null的属性不会保存，会使用数据库默认值，不能用insert，insert会将没有的属性设置成null而不是数据库的默认值
        return id;
    }
    ...
    public PagedResult getAllVideos(Videos video, Integer isSaveRecord, Integer page, Integer pageSize) {
        ...
        PageHelper.startPage(page, pageSize); //page:查询几页，pageSize:每一页查询的条数
